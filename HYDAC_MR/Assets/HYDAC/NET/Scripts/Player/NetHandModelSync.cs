...
{
    public class NetHandModelSync: MonoBehaviourPunCallbacks, IPunObservable
    {       
        [Header("Hands Sync Helpers")]
        [SerializeField]
        NetHandJointTrackingSync rightHandSyncController = null;
        
        [SerializeField]
        NetHandJointTrackingSync leftHandSyncController = null;
